...
Short on time? In order: [Overview](../introduction/overview.md) → [x402 + ERC-7710](../core-concepts/x402-and-erc-7710.md)
→ [Security model](../core-concepts/security-model.md) → run the [Demo Guide](../getting-started/demo-guide.md) three scenarios.
